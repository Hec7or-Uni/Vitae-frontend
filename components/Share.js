        ...
        <div className='mt-2 flex flex-col gap-2'>
          <div className='mt-1.5 flex flex-wrap w-full h-full gap-2'>
            {[{
              ...
              text: 'email',
              msg: `https://mail.google.com/mail/u/0/?fs=1&tf=cm&to&su=Visit+Vitop+platform&body=${uri}&ui=2`
            }, {
              id: 2,
          ...
          <div className='mt-1.5 flex flex-wrap w-full h-full gap-2'>
            {[{
              ...
              text: 'reddit',
              msg: `http://www.reddit.com/submit?url=${uri}&title=Visit+Vitop+platform`
            }, {
              id: 2,
